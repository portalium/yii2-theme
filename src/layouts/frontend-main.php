...
<?php
    NavBar::begin([
        'brandLabel' => ($settings['app::logo'] == "0") ? Html::encode($settings['app::title']) : Html::img(Yii::$app->request->baseUrl.'/data/'.strval(Html::encode(json_decode($settings['app::logo'],true)['name'])),['height' => '30px']),
